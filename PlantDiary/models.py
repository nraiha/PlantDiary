...
class Plant(db.Model):
    ...
    general_plant = db.relationship("PlantGeneral", back_populates="plant")
    diary = db.relationship("DiaryItem", back_populates="plant")
...
class PlantGeneral(db.Model):
    ...
    specie = db.Column(db.String(128), nullable=False)
    plant = db.relationship("Plant", back_populates="general_plant")
...
class Diary(db.Model):
    ...
    plant = db.relationship("PlantItem", back_populates="diary")
